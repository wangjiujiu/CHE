package com.qc.language.common.view.checkbox;
...
/**
 * @author Beckett_W
 * @version Id: SmoothCheckBox, v 0.1 2017/8/20 10:56 Beckett_W Exp $$
 */
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void startUnCheckedAnimation() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                SmoothCheckBox.this.mScaleVal = ((Float)animation.getAnimatedValue()).floatValue();
                SmoothCheckBox.this.mFloorColor = SmoothCheckBox.getGradientColor(SmoothCheckBox.this.mCheckedColor, SmoothCheckBox.COLOR_FLOOR_UNCHECKED, SmoothCheckBox.this.mScaleVal);
                SmoothCheckBox.this.postInvalidate();
            }
        });
        animator.start();
