package com.qc.language.common.view.textview;
...
public class SpansManager {
    ...
    public void doFillBlank(String examStr){
        ...
        String quesOptionAsksResult = examStr;
        for(int i =0;i<20;i++){
            quesOptionAsksResult =  quesOptionAsksResult.replaceAll("_"+i+"_",FILL_TAG);
            if(i==19){
                Spanned spanned = Html.fromHtml(quesOptionAsksResult, null, new Html.TagHandler() {
                    ...
                    public void handleTag(boolean opening, String tag, Editable output, XMLReader xmlReader) {
                        if (tag.equalsIgnoreCase(FILL_TAG_NAME) && opening) {
                            ...
                            paint.setColor(mTv.getResources().getColor(R.color.colorBlueText));
    ...
    public void setSpanChecked(int position){
        ...
        for (int i = 0 ; i < mSpans.size();i++) {
            ...
            if (i == position) {
                ...
                replaceSpan.setDrawTextColor(R.color.colorBlueText);
            }
            mTv.invalidate();
        }
    }
