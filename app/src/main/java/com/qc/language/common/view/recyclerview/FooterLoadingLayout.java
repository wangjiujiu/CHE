 ...
 * @version Id: FooterLoadingLayout, v 0.1 2017/7/10 9:12 Administrator Exp $$
 */
public class FooterLoadingLayout extends LoadingLayout {
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.rv_pull_to_load_footer, null, false);
        return container;
    }
