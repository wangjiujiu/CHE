 ...
 */
public class McmDetailPresenter extends RxPresenter<McmDetailContract.View> implements McmDetailContract.Presenter<McmDetailContract.View>{

    private ApiService apiService;
    @Inject
    public McmDetailPresenter(ApiService apiService) {
