...
import com.qc.language.ui.question.read.rp.data.RpData;
 ...
 */
public class RpListActivity extends CommonActivity implements OnRecyclerViewItemClickListener, RpListContract.View{
    ...
    private RpListAdapter rsListAdapter;


    @Inject
    MyApplication application;
    @Inject
    RpListPresenter rsListPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitleTextView.setText("Re-order paragraphs");

        refreshRecyclerView =(RefreshRecyclerView)findViewById(R.id.common_list_act_rv);
        List<RpData> datas = new ArrayList<>();
        rsListAdapter = new RpListAdapter(this,datas);
        ...
        //假数据
        List<RpData> rsDataList = new ArrayList<>();
       for(int i=0;i<5;i++){
           RpData rsData = new RpData();
    ...
    public void onItemClick(View view, Object data) {
        ...
        intent.setClass(getContext(),RpDetailActivity.class);
