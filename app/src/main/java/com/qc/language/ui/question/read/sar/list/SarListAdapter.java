 ...
 * 收藏列表
 */
public class SarListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {

    private OnRecyclerViewItemClickListener listener;
    private List<SarData> items;
    ...
    public SarListAdapter(Context context, List<SarData> items) {
        this.items = items;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder  holder, final int position) {
        ...
        if(EMPTY_VIEW!=itemViewType){
            final SarData item = items.get(position);
    ...
    public void resetList(List<SarData> list) {
        mEmptyType = 0;
        items.clear();
        items.addAll(list);
    }

    public void addList(List<SarData> list) {
        mEmptyType = 0;
        items.addAll(list);
    }
    ...
    public interface onItemDetailListener {
        void onDetailClick(int i, SarData favoriteData);
    }
    ...
    public interface onSwipeListener {
        void onDel(int pos, SarData favoriteData);
