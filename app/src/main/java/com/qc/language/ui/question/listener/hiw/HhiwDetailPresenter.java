 ...
 */
public class HhiwDetailPresenter extends RxPresenter<HhiwDetailContract.View> implements HhiwDetailContract.Presenter<HhiwDetailContract.View>{

    private ApiService apiService;
    @Inject
    public HhiwDetailPresenter(ApiService apiService) {
