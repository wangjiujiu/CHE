package com.qc.language.ui.question.speak.rs;
 ...
 */
public class SrsDetailFragment extends CommonFragment implements RADetailContract.View{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View parentView = inflater.inflate(R.layout.speak_rs_detail, container, false);
