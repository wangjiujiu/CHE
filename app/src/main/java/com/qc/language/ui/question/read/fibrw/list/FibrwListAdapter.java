 ...
 *
 */
public class FibrwListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {

    private OnRecyclerViewItemClickListener listener;
    private List<FibrwData> items;
    ...
    public FibrwListAdapter(Context context, List<FibrwData> items) {
        this.items = items;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder  holder, final int position) {
        ...
        if(EMPTY_VIEW!=itemViewType){
            final FibrwData item = items.get(position);
    ...
    public void resetList(List<FibrwData> list) {
        mEmptyType = 0;
        items.clear();
        items.addAll(list);
    }

    public void addList(List<FibrwData> list) {
        mEmptyType = 0;
        items.addAll(list);
    }
    ...
    public interface onItemDetailListener {
        void onDetailClick(int i, FibrwData favoriteData);
    }
    ...
    public interface onSwipeListener {
        void onDel(int pos, FibrwData favoriteData);
