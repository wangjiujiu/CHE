 ...
 */
public class HmcmDetailPresenter extends RxPresenter<HmcmDetailContract.View> implements HmcmDetailContract.Presenter<HmcmDetailContract.View>{

    private ApiService apiService;
    @Inject
    public HmcmDetailPresenter(ApiService apiService) {
