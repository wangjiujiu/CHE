 ...
 */
public class HfiblDetailPresenter extends RxPresenter<HfiblDetailContract.View> implements HfiblDetailContract.Presenter<HfiblDetailContract.View>{

    private ApiService apiService;
    @Inject
    public HfiblDetailPresenter(ApiService apiService) {
