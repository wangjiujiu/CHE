 ...
 * 收藏列表
 */
public class RAListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {

    private OnRecyclerViewItemClickListener listener;
    private List<RAData> items;
    ...
    public RAListAdapter(Context context, List<RAData> items) {
        this.items = items;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder  holder, final int position) {
        ...
        if(EMPTY_VIEW!=itemViewType){
            final RAData item = items.get(position);
    ...
    public void resetList(List<RAData> list) {
        mEmptyType = 0;
        items.clear();
        items.addAll(list);
    }

    public void addList(List<RAData> list) {
        mEmptyType = 0;
        items.addAll(list);
    }
    ...
    public interface onItemDetailListener {
        void onDetailClick(int i, RAData favoriteData);
    }
    ...
    public interface onSwipeListener {
        void onDel(int pos, RAData favoriteData);
