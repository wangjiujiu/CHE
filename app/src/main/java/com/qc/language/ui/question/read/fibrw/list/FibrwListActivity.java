...
import com.qc.language.ui.question.read.fibrw.data.FibrwData;
 ...
 */
public class FibrwListActivity extends CommonActivity implements OnRecyclerViewItemClickListener, FibrwListContract.View{
    ...
    private FibrwListAdapter rsListAdapter;


    @Inject
    MyApplication application;
    @Inject
    FibrwListPresenter rsListPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<FibrwData> datas = new ArrayList<>();
        rsListAdapter = new FibrwListAdapter(this,datas);
        ...
        //假数据
        List<FibrwData> rsDataList = new ArrayList<>();
       for(int i=0;i<5;i++){
           FibrwData rsData = new FibrwData();
    ...
    public void onItemClick(View view, Object data) {
        ...
        intent.setClass(getContext(),FibrwDetailActivity.class);
