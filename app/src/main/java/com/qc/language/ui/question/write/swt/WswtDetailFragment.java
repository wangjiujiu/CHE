...
import com.qc.language.ui.question.write.we.WwfdDetailContract;
import com.qc.language.ui.question.write.we.WwfdDetailPresenter;
 ...
 * 写作
 */
public class WswtDetailFragment extends CommonFragment implements WswtDetailContract.View{
    ...
    @Inject
    WswtDetailPresenter hsstDetailPresenter;
