 ...
 */
public class SrlDetailFragment extends CommonFragment implements RADetailContract.View{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View parentView = inflater.inflate(R.layout.speak_rl_detail, container, false);
    ...
    public void loadSuccess(QDetail hqDetail) {
        if(hqDetail.getData()!=null){
            ...
            if(hqDetail.getData().getAnswer()!=null){
                ...
                if (hqDetail.getData().getImage() != null && !StringUtils.isEmpty(hqDetail.getData().getImage())) {
                    //Picasso加载图片
                    String url = Constant.API_DOWNLOAD_FILE + hqDetail.getData().getImage();
