 ...
 *
 */
public class RpListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {

    private OnRecyclerViewItemClickListener listener;
    private List<RpData> items;
    ...
    public RpListAdapter(Context context, List<RpData> items) {
        this.items = items;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder  holder, final int position) {
        ...
        if(EMPTY_VIEW!=itemViewType){
            final RpData item = items.get(position);
    ...
    public void resetList(List<RpData> list) {
        mEmptyType = 0;
        items.clear();
        items.addAll(list);
    }

    public void addList(List<RpData> list) {
        mEmptyType = 0;
        items.addAll(list);
    }
    ...
    public interface onItemDetailListener {
        void onDetailClick(int i, RpData favoriteData);
    }
    ...
    public interface onSwipeListener {
        void onDel(int pos, RpData favoriteData);
