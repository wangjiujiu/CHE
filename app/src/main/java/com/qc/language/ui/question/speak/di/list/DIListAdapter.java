...
public class DIListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {

    private OnRecyclerViewItemClickListener listener;
    private List<DIData> items;
    ...
    public DIListAdapter(Context context, List<DIData> items) {
        this.items = items;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder  holder, final int position) {
        ...
        if(EMPTY_VIEW!=itemViewType){
            final DIData item = items.get(position);
    ...
    public void resetList(List<DIData> list) {
        mEmptyType = 0;
        items.clear();
        items.addAll(list);
    }

    public void addList(List<DIData> list) {
        mEmptyType = 0;
        items.addAll(list);
    }
    ...
    public interface onItemDetailListener {
        void onDetailClick(int i, DIData favoriteData);
    }
    ...
    public interface onSwipeListener {
        void onDel(int pos, DIData favoriteData);
