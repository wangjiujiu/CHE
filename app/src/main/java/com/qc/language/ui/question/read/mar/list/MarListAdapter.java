 ...
 * 收藏列表
 */
public class MarListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {

    private OnRecyclerViewItemClickListener listener;
    private List<MarData> items;
    ...
    public MarListAdapter(Context context, List<MarData> items) {
        this.items = items;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder  holder, final int position) {
        ...
        if(EMPTY_VIEW!=itemViewType){
            final MarData item = items.get(position);
    ...
    public void resetList(List<MarData> list) {
        mEmptyType = 0;
        items.clear();
        items.addAll(list);
    }

    public void addList(List<MarData> list) {
        mEmptyType = 0;
        items.addAll(list);
    }
    ...
    public interface onItemDetailListener {
        void onDetailClick(int i, MarData favoriteData);
    }
    ...
    public interface onSwipeListener {
        void onDel(int pos, MarData favoriteData);
