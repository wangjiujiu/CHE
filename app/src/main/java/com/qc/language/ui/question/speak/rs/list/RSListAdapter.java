 ...
 * 收藏列表
 */
public class RSListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {

    private OnRecyclerViewItemClickListener listener;
    private List<RSData> items;
    ...
    public RSListAdapter(Context context, List<RSData> items) {
        this.items = items;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder  holder, final int position) {
        ...
        if(EMPTY_VIEW!=itemViewType){
            final RSData item = items.get(position);
    ...
    public void resetList(List<RSData> list) {
        mEmptyType = 0;
        items.clear();
        items.addAll(list);
    }

    public void addList(List<RSData> list) {
        mEmptyType = 0;
        items.addAll(list);
    }
    ...
    public interface onItemDetailListener {
        void onDetailClick(int i, RSData favoriteData);
    }
    ...
    public interface onSwipeListener {
        void onDel(int pos, RSData favoriteData);
