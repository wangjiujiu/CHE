 ...
 */
public class SdiDetailFragment extends CommonFragment implements DIDetailContract.View{
...
//    MediaPlayer testPlayer = new MediaPlayer();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View parentView = inflater.inflate(R.layout.speak_di_detail, container, false);
    ...
    public void loadSuccess(QDetail hqDetail) {
        if(hqDetail.getData()!=null){
            ...
            if(hqDetail.getData().getFile()!=null&&!StringUtils.isEmpty(hqDetail.getData().getFile())){
                  //Picasso加载图片
                String url = Constant.API_DOWNLOAD_FILE+hqDetail.getData().getFile();
