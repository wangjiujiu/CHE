 ...
 */
public class HwfdDetailActivity extends CommonActivity implements HwfdDetailContract.View{
    ...
    @Inject
    HwfdDetailPresenter hsstDetailPresenter;
    ...
    private void setListener() {
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                HwfdDetailActivity.this.finish();
            }
        });
