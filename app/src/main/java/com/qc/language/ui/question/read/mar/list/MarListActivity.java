...
import com.qc.language.ui.question.read.mar.data.MarData;
 ...
 */
public class MarListActivity extends CommonActivity implements OnRecyclerViewItemClickListener, MarListContract.View{
    ...
    private MarListAdapter rsListAdapter;


    @Inject
    MyApplication application;
    @Inject
    MarListPresenter rsListPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitleTextView.setText("MC,Multiple Answer");

        refreshRecyclerView =(RefreshRecyclerView)findViewById(R.id.common_list_act_rv);
        List<MarData> datas = new ArrayList<>();
        rsListAdapter = new MarListAdapter(this,datas);
        ...
        //假数据
        List<MarData> rsDataList = new ArrayList<>();
       for(int i=0;i<5;i++){
           MarData rsData = new MarData();
    ...
    public void onItemClick(View view, Object data) {
        ...
        intent.setClass(getContext(),MarDetailActivity.class);
