 ...
 */
public class HhcsDetailPresenter extends RxPresenter<HhcsDetailContract.View> implements HhcsDetailContract.Presenter<HhcsDetailContract.View>{

    private ApiService apiService;
    @Inject
    public HhcsDetailPresenter(ApiService apiService) {
