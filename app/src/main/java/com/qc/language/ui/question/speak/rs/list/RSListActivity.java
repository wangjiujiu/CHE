 ...
 */
public class RSListActivity extends CommonActivity implements OnRecyclerViewItemClickListener, RSListContract.View{
    ...
    private RSListAdapter rsListAdapter;


    @Inject
    MyApplication application;
    @Inject
    RSListPresenter rsListPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitleTextView.setText("Repeat Sentence");

        refreshRecyclerView =(RefreshRecyclerView)findViewById(R.id.common_list_act_rv);
        List<RSData> datas = new ArrayList<>();
        rsListAdapter = new RSListAdapter(this,datas);
    ...
    public void onItemClick(View view, Object data) {
        ...
        intent.setClass(getContext(),RSDetailActivity.class);
