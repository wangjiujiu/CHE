 ...
 */
public class RADetailActivity extends CommonActivity implements RADetailContract.View{
    ...
    @Inject
    RADetailPresenter rsDetailPresenter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ra_detail_act);
        ...
        //假数据
        contentTv.setText("For any marketing course that requires the development of a marketing plan,such as Marketing……");
