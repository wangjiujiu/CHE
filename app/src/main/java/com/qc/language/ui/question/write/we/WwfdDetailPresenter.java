 ...
 */
public class WwfdDetailPresenter extends RxPresenter<WwfdDetailContract.View> implements WwfdDetailContract.Presenter<WwfdDetailContract.View>{

    private ApiService apiService;
    @Inject
    public WwfdDetailPresenter(ApiService apiService) {
