 ...
 * 收藏列表
 */
public class AsqListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {

    private OnRecyclerViewItemClickListener listener;
    private List<AsqData> items;
    ...
    public AsqListAdapter(Context context, List<AsqData> items) {
        this.items = items;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder  holder, final int position) {
        ...
        if(EMPTY_VIEW!=itemViewType){
            final AsqData item = items.get(position);
    ...
    public void resetList(List<AsqData> list) {
        mEmptyType = 0;
        items.clear();
        items.addAll(list);
    }

    public void addList(List<AsqData> list) {
        mEmptyType = 0;
        items.addAll(list);
    }
    ...
    public interface onItemDetailListener {
        void onDetailClick(int i, AsqData favoriteData);
    }
    ...
    public interface onSwipeListener {
        void onDel(int pos, AsqData favoriteData);
