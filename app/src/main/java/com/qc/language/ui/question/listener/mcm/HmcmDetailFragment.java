 ...
 * 听力多选
 */
public class HmcmDetailFragment extends CommonFragment implements HmcmDetailContract.View{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View parentView = inflater.inflate(R.layout.listener_mcs_detail_frag, container, false);
    ...
    public void loadSuccess(QDetail hqDetail) {
        if(hqDetail.getData()!=null){
            ...
            if(hqDetail.getData().getAsk()!=null){
                String htmlcontent = hqDetail.getData().getAsk().replaceAll("font","androidfont");
                ...
                adapter.setOnItemClickListener(new PickAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        if(haschooseitems.contains(dataList.get(position))){
                            //不选中
                            String needRemoteId = dataList.get(position).getSeq();
                            OptionData needRemoteObject = null;
                            for (OptionData obj : haschooseitems) {
                                if (obj.getSeq().equals(needRemoteId)) {
