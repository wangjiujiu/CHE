package com.qc.language.ui.question.speak.ra;
...
/**
 * 说，ra 文本 答题是能录音 能播放给自己听 答案是音频文件
 */
public class SraDetailFragment extends CommonFragment implements RADetailContract.View{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View parentView = inflater.inflate(R.layout.speak_ra_detail, container, false);
    ...
    public void loadSuccess(QDetail hqDetail) {
        if(hqDetail.getData()!=null){
            ...
            if(hqDetail.getData().getFile()!=null&&!StringUtils.isEmpty(hqDetail.getData().getFile())){
                attachmentFile = hqDetail.getData().getFile();
            }else{
                attachmentFile = "";
            }
