 ...
 */
public class RmcsDetailPresenter extends RxPresenter<RmcsDetailContract.View> implements RmcsDetailContract.Presenter<RmcsDetailContract.View>{

    private ApiService apiService;
    @Inject
    public RmcsDetailPresenter(ApiService apiService) {
