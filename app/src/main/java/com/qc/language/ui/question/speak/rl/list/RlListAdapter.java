...
public class RlListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {

    private OnRecyclerViewItemClickListener listener;
    private List<RLData> items;
    ...
    public RlListAdapter(Context context, List<RLData> items) {
        this.items = items;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder  holder, final int position) {
        ...
        if(EMPTY_VIEW!=itemViewType){
            final RLData item = items.get(position);
    ...
    public void resetList(List<RLData> list) {
        mEmptyType = 0;
        items.clear();
        items.addAll(list);
    }

    public void addList(List<RLData> list) {
        mEmptyType = 0;
        items.addAll(list);
    }
    ...
    public interface onItemDetailListener {
        void onDetailClick(int i, RLData favoriteData);
    }
    ...
    public interface onSwipeListener {
        void onDel(int pos, RLData favoriteData);
