 ...
 */
public class ListenerListPresenter extends RxPresenter<ListenerListContract.View> implements ListenerListContract.Presenter<ListenerListContract.View>{

    private ApiService apiService;
    @Inject
    public ListenerListPresenter(ApiService apiService) {
