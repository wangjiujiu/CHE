...
import com.qc.language.ui.question.listener.wfd.HwfdDetailContract;
import com.qc.language.ui.question.listener.wfd.HwfdDetailPresenter;
 ...
 * 听力单选
 */
public class HmcsDetailActivity extends CommonActivity implements HmcsDetailContract.View{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listener_mcs_detail);
        ...
        myAnswerEt = (EditText) findViewById(R.id.listener_fill_answer);
    ...
    private void setListener() {
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                HmcsDetailActivity.this.finish();
            }
        });
