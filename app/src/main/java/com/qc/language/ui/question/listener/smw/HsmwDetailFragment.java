...
import com.qc.language.ui.question.listener.hcs.HhcsDetailContract;
import com.qc.language.ui.question.listener.hcs.HhcsDetailPresenter;
 ...
 * 单选,个数不固定
 */
public class HsmwDetailFragment extends CommonFragment implements HsmwDetailContract.View{
